...
The resulting `constitution.pdf` document is available from the `release <https://github.com/UKPythonAssociation/ukpa-constitution/releases/latest>`_ link above.
